...
public class AuthConfig {
    @Bean
    AuthApplicationService authApplicationService(AuthenticationManagerPort authenticationManagerPort, TokenServicePort tokenServicePort, ValidationUtils validationUtils,RoleRepositoryPort roleRepositoryPort, UserRepositoryPort userRepositoryPort){
        return new AuthApplicationService(authenticationManagerPort, tokenServicePort, validationUtils,roleRepositoryPort,userRepositoryPort);
    }
